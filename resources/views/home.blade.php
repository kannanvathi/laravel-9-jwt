                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="home_right_img">
                            <img class="" src="{{asset('assets/images/img/banner/home-right.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row feature_inner">
                <div class="col-lg-3 col-md-6">
                    <div class="feature_item">
                        <img src="{{asset('assets/images/img/services/s1.png')}}" alt="">
                        <h4>Wp developing</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature_item">
                        <img src="{{asset('assets/images/img/services/s2.png')}}" alt="">
                        <h4>UI/ux design</h4>
                        <p>Creeping for female light years that lesser can't evening heaven isn't bearing tree</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="feature_item">
                        <img src="{{asset('assets/images/img/services/s3.png')}}" alt="">
                        <h4>Web design</h4>
                        <p>Creeping for female light years that lesser can't evening heaven isn't bearing tree</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="feature_item">
                        <img src="{{asset('assets/images/img/services/s4.png')}}" alt="">
                        <h4>seo optimize</h4>
                        <p>Creeping for female light years that lesser can't evening heaven isn't bearing tree</p>
                    </div>
                </div>
            ...
            <div class="filters-content">
                <div class="row portfolio-grid justify-content-center">
                    <div class="col-lg-4 col-md-6 all latest">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p1.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p1.jpg')}}" class="img-gal">
                                    <div class="icon">
                    ...
                    <div class="col-lg-4 col-md-6 all popular">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p2.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p2.jpg')}}" class="img-gal">
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                                    </div>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 all latest">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p3.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p3.jpg')}}" class="img-gal">
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                                    </div>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 all popular">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p4.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p4.jpg')}}" class="img-gal">
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                                    </div>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 all following">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p6.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p5.jpg')}}" class="img-gal">
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                                    </div>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 all upcoming">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p5.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p6.jpg')}}" class="img-gal">
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                                    </div>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 all upcoming following">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p7.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p7.jpg')}}" class="img-gal">
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                                    </div>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 all following">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p8.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p8.jpg')}}" class="img-gal">
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                                    </div>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 all upcoming">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                <img class="img-fluid w-100" src="{{asset('assets/images/img/portfolio/p9.jpg')}}" alt="">
                                <div class="overlay"></div>
                                <a href="{{asset('assets/images/img/portfolio/p9.jpg')}}" class="img-gal">
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                                    </div>
                                </a>
